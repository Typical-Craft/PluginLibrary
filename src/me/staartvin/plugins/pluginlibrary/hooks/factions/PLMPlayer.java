...
/**
 * Represents the {@link com.massivecraft.factions.entity.MPlayer} class. <br>
 * This class mirroring is used so developers don't have to import the API of
 * Factions. <br>
 * This can either be a console or a real player. You can check with
 * {@link #isConsole()} and {@link #isPlayer()}.
 * <p>
 * Date created: 23:56:36 13 aug. 2015
 * 
 * @author Staartvin
 *
 */
public class PLMPlayer {
	...
	/**
	 * Gets the faction id of the faction that the player is part of. <br>
	 * <b>This will never be null.</b> If a player does not belong to a
	 * 'human-made' faction, <br>
	 * it will return the id of the wilderness, warzone or safezone.
	 * 
	 * @return A faction id corresponding to the faction the player is currently
	 *         in.
	 */
	...
	/**
	 * Gets the faction the player is part of. <br>
	 * <b>This will never be null.</b> See {@link #getFactionId()} for more
	 * info.
	 * 
	...
	/**
	 * Gets the role of the player in his current faction. <br>
	 * <b>This will never be null</b> as the player is always in a faction. See
	 * {@link #getFactionId()} for more info. <br>
	...
	/**
	 * Sets the role of a player in his current faction. <br>
	...
	/**
	 * Gets the title of the player in his current faction. <br>
	...
	/**
	 * Sets the title of the player in his current faction. <br>
	 * The title is just for fun. It's not connected to any game mechanic.
	 * 
	 * @param title
	 ...
	 * 
	 * @param value
	 *            Value to set the use of admin mode to.
	 */
	...
	/**
	 * Whether or not this player is in enemy territory (land of another
	 * faction).
	 * 
	 * @return true if the player is; false otherwise.
	 */
	...
	/**
	 * Gets the relation from this player towards another player. <br>
	 * The relation types it can return are: LEADER, OFFICER, MEMBER, RECRUIT,
	 * ALLY, TRUCE, NEUTRAL and ENEMY.
	 * 
	 * @param otherPlayer
	 *            Other player.
	...
	public String getRelationTo(PLMPlayer otherPlayer) {
		com.massivecraft.factions.entity.MPlayer player = com.massivecraft.factions.entity.MPlayer
				.get(otherPlayer.getUUID());
	...
	/**
	 * Gets the relation from this player towards a faction. <br>
	 * The relation types it can return are: LEADER, OFFICER, MEMBER, RECRUIT,
	 * ALLY, TRUCE, NEUTRAL and ENEMY.
	 * 
	 * @param faction
	...
	/**
	 * Whether this player is currently part of a non-default (so no Wilderness,
	 * Safezone or Warzone) faction.
	 * 
	 * @return true if the player is; false otherwise.
	 */
	...
	/**
	 * Wipes all faction data of this player. <br>
	 * Will delete the current faction he's in, his title, his role and sets
	 * auto claiming to false. <br>
	 * <b>Take caution with this method, I've not tested it.</b>
	 */
