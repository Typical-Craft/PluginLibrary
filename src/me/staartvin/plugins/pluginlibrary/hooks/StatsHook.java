...
/**
 * Stats library, <a
 * href="https://www.spigotmc.org/resources/stats.3638//">link</a>.
 * <p>
...
public class StatsHook extends LibraryHook {
	 ...
	 * <p>
	 * You must specify the UUID of the player and the item id of the block. <br>
	...
	public int getBlocksBroken(final UUID uuid, final int id,
		...
		final Collection<StatEntry> stat = getStatType("Blocks broken", uuid);
	 ...
	 * <br>This is just for generic stats.
	 * <br>Most stats can be retrieved with this method:
	 * <br><b>Arrows, Beds entered, Buckets emptied, Buckets filled, Commands done, Damage taken, Eggs thrown, Fish caught, Joins,
	 *  Last join, Last seen, Money, Omnomnom (amount of food eaten), PVP streak, PVP top streak, Playtime, Shears, Teleports, 
	 *  Times kicked, Trades, Votes, Words said, Times changed world, XP gained</b>
	 *  
	...
	/**
	 * Gets the total amount of all broken blocks. It ignores item id or damage value.
	 * <br>If you want to check the amount of broken blocks for a certain type of block or with a damage value,
	 * <br>use {@link #getBlocksBroken(UUID, int, int, String)}.
	 * @param uuid UUID of the player.
	 * @param worldName Name of the world, or null for global.
	 ...
	 * <br>5: By horse
	 * 
	 * <p>If you want to check on all worlds, use null as worldName.
	...
	/**
	 * Gets the total amount of all placed blocks. It ignores item id or damage value.
	 * <br>If you want to check the amount of placed blocks for a certain type of block or with a damage value,
	 * <br>use {@link #getBlocksPlaced(UUID, int, int, String)}.
	 * @param uuid UUID of the player.
	 * @param worldName Name of the world, or null for global.
	 ...
	 * <br>You can specify a mob name. If you don't, it will return the total amount of mob kills.
	 * <br>A few special mobs are the 'wither_skeleton', 'charged_creeper', 'spider_jockey', 'chicken_jockey' and 'elder_guardian'.
	 * @param uuid UUID of the player.
	 ...
	 * <br>If you only want to know about the total amount of food eaten, use {@link #getNormalStat(UUID, String, String)} with statName as 'Omnomnom' instead.
	 * <p>A list of usable food types can be found <a href="https://github.com/Armarr/Autorank-2/wiki/Food-types">here</a>. 
	 * @param uuid UUID of the player.
	 * @param worldName Name of the world, or null for global.
